...
const ContactSection = () => {
    return (
      <section id="contact" className="text-gray-400 body-font relative bg-black">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Contact Us</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Want to join us and work with us? Fill out the form below.
            </p>
          </div>
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg">Submit</button>
              </div>
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-800 text-center">
                <a href="mailto:geekroom.jimsemtc@gmail.com" className="text-indigo-400">geekroom.jimsemtc@gmail.com</a>
                <p className="leading-normal my-5">@2025 All Rights Reserved By <br /> GeekRoom-JIMSEMTC</p>
